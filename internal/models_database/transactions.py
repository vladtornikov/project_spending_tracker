...
from sqlalchemy.dialects.postgresql import DATE, JSONB, NUMERIC, TIMESTAMP
from sqlalchemy.orm import Mapped, mapped_column

from internal.database import BaseORM

from .categories import CategoriesModel, CategoryTypeEnum, enum_type
...
class TransactionsModel(BaseORM):
    ...
    transaction_type: Mapped[CategoryTypeEnum] = mapped_column(
        enum_type, nullable=False
    )
